...
def eval_nn(genotype, nbstep=5000, render=False, name="", nn_size=[12, 2, 2, 10]):
...
def launch_nsga2(mu=100, lambda_=200, cxpb=0.6, mutpb=0.3, ngen=200, variant="FIT", nn_size=[12, 2, 2, 10], verbose=False):
    ...
    toolbox.register("mutate", tools.mutPolynomialBounded,
                     eta=15, low=-5, up=5, indpb=1.0/IND_SIZE)
...
if (__name__ == "__main__"):
    ...
    parser.add_argument('--nb_gen', type=int, default=500,
    ...
    pop, logbook, paretofront = launch_nsga2(
